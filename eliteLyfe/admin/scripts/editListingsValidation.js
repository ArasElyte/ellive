...
function ValidateMe(id, value) {
    ...
    switch (id) {
        ...
        case "geoSubDivision1":
        case "geoSubDivision2":
        case "geoSubDivision3":
        case "e_listingFeeType":
        case "e_rateType":
        ...
        case "e_rateMinStay":
        case "e_feeAmount":
            isValid = ((val !== "0" && val !== ""  && parseInt(val)>=1) ? true : false);
            break;
...
function CheckIfInt(e, minLen, maxLen) {
    e = e || window.event;
    var asciiCode = e.which ? e.which : e.keyCode;
    var asciiVal = String.fromCharCode(asciiCode);
...
/*■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■*/
function CheckIfFloat(e, minLen, maxLen) {
